...
import { WorkflowPhase, WorkflowSession, WorkflowOperation } from '@/types/workflow'
...
export class PhaseManager {
  ...
  canTransition(state: WorkflowSession['state']): PhaseTransitionResult {
    const { phase, selected, configured, validated, workflow, pendingClarifications } = state
   ...
   */
  validateOperation(operation: WorkflowOperation, currentPhase: WorkflowPhase): boolean {
