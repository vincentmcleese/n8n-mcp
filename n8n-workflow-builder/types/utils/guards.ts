...
export function isN8nWorkflowConnections(obj: any): obj is N8nWorkflowConnections {
  if (typeof obj !== 'object' || obj === null) return false;
  
  return Object.entries(obj).every(([key, value]) => {
    if (typeof key !== 'string') return false;
    if (typeof value !== 'object' || value === null) return false;
    if (!value.main || !Array.isArray(value.main)) return false;
    
    return value.main.every((output: any) => 
...
export function isN8nWorkflowSettings(obj: any): obj is N8nWorkflowSettings {
  ...
  if (obj.executionOrder && !validExecutionOrders.includes(obj.executionOrder)) {
    return false;
  }
  
  if (obj.saveDataSuccessExecution && !validSaveDataOptions.includes(obj.saveDataSuccessExecution)) {
    return false;
  }
  
  if (obj.saveDataErrorExecution && !validSaveDataOptions.includes(obj.saveDataErrorExecution)) {
    return false;
  }
...
export function isClaudeAnalysisResponse(obj: any): obj is ClaudeAnalysisResponse {
  return (
    isBaseClaudeResponse(obj) &&
    typeof obj.intent === 'string' &&
    Array.isArray(obj.requiredCapabilities) &&
    Array.isArray(obj.suggestedSearchTerms) &&
    Array.isArray(obj.nodeRecommendations)
  );
}

export function isDiscoveryOperationsResponse(obj: any): obj is DiscoveryOperationsResponse {
  return (
    isBaseClaudeResponse(obj) &&
    Array.isArray(obj.operations) &&
    obj.operations.every((op: any) => 
      typeof op === 'object' &&
      typeof op.type === 'string' &&
      ['discoverNode', 'selectNode', 'deselectNode', 'requestClarification'].includes(op.type)
    )
  );
}

export function isConfigurationOperationsResponse(obj: any): obj is ConfigurationOperationsResponse {
  return (
    isBaseClaudeResponse(obj) &&
    Array.isArray(obj.operations) &&
    obj.operations.every((op: any) => 
...
export function isWorkflowBuildResponse(obj: any): obj is WorkflowBuildResponse {
  return (
    isBaseClaudeResponse(obj) &&
    typeof obj.name === 'string' &&
    Array.isArray(obj.nodes) &&
...
export function isValidatedWorkflowResponse(obj: any): obj is ValidatedWorkflowResponse {
  return (
    isBaseClaudeResponse(obj) &&
    typeof obj.workflow === 'object' &&
    typeof obj.workflow.name === 'string' &&
    Array.isArray(obj.workflow.nodes) &&
    typeof obj.workflow.connections === 'object' &&
    typeof obj.validationReport === 'object'
  );
}

export function isDocumentationOperationsResponse(obj: any): obj is DocumentationOperationsResponse {
  return (
    isBaseClaudeResponse(obj) &&
    Array.isArray(obj.operations) &&
    obj.operations.every((op: any) => 
