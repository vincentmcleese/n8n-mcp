...
[![smithery badge](https://smithery.ai/badge/@vincentmcleese/n8n-mcp-prod)](https://smithery.ai/server/@vincentmcleese/n8n-mcp-prod)
...
To install n8n-mcp-prod for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@vincentmcleese/n8n-mcp-prod):

```bash
npx -y @smithery/cli install @vincentmcleese/n8n-mcp-prod --client claude
```
